        ...
        <div className="all_info">
          ...
          <div className="content">
            <p className="description">
              ...
              acurate and the aim is to ensure that this mini-robot can
              accurately perform an action repeatedly.
            </p>
          ...
          <div className="contraint_container">
            <div className="contraint">
              <h1>Purpose</h1>
              The purpose of this project is to perform actions involving the
              pick up and transportation of parts in a predictatable and
              accurate manner.
            </div>
            <div className="contraint">
              <h1>Approach</h1>
