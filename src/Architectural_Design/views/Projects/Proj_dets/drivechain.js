      ...
      <div className="head1">
        ...
        <div className="all_info">
          ...
          <div className="contraint_container">
            ...
            <p className="contraint">
              <h1>Approach</h1>A simple open differential was utilized. This
              would allow for AGV wheels to turn indepentently from each other
              thus limiting the wear and tear on each axle.
            </p>
            <p className="contraint">
              <h1>Results</h1>
